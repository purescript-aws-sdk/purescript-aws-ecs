...
createCluster = Request.request service method  where
    service = Request.ServiceName "ECS"
...
createService = Request.request service method  where
    service = Request.ServiceName "ECS"
    method = Request.MethodName "createService"
...
deleteService = Request.request service method  where
    service = Request.ServiceName "ECS"
    method = Request.MethodName "deleteService"
...
deregisterContainerInstance = Request.request service method  where
    service = Request.ServiceName "ECS"
    method = Request.MethodName "deregisterContainerInstance"
...
deregisterTaskDefinition = Request.request service method  where
    service = Request.ServiceName "ECS"
    method = Request.MethodName "deregisterTaskDefinition"
...
describeContainerInstances = Request.request service method  where
    service = Request.ServiceName "ECS"
    method = Request.MethodName "describeContainerInstances"
...
describeTaskDefinition = Request.request service method  where
    service = Request.ServiceName "ECS"
    method = Request.MethodName "describeTaskDefinition"


-- | <p>Describes a specified task or tasks.</p>
describeTasks :: forall eff. DescribeTasksRequest -> Aff (exception :: EXCEPTION | eff) DescribeTasksResponse
describeTasks = Request.request service method  where
    service = Request.ServiceName "ECS"
    method = Request.MethodName "describeTasks"
...
discoverPollEndpoint = Request.request service method  where
    service = Request.ServiceName "ECS"
    method = Request.MethodName "discoverPollEndpoint"
...
listAttributes = Request.request service method  where
    service = Request.ServiceName "ECS"
    method = Request.MethodName "listAttributes"
...
listContainerInstances = Request.request service method  where
    service = Request.ServiceName "ECS"
    method = Request.MethodName "listContainerInstances"
...
listServices = Request.request service method  where
    service = Request.ServiceName "ECS"
    method = Request.MethodName "listServices"
...
listTaskDefinitionFamilies = Request.request service method  where
    service = Request.ServiceName "ECS"
    method = Request.MethodName "listTaskDefinitionFamilies"
...
listTaskDefinitions = Request.request service method  where
    service = Request.ServiceName "ECS"
    method = Request.MethodName "listTaskDefinitions"
...
listTasks = Request.request service method  where
    service = Request.ServiceName "ECS"
    method = Request.MethodName "listTasks"
...
registerContainerInstance = Request.request service method  where
    service = Request.ServiceName "ECS"
    method = Request.MethodName "registerContainerInstance"
...
registerTaskDefinition = Request.request service method  where
    service = Request.ServiceName "ECS"
    method = Request.MethodName "registerTaskDefinition"
...
runTask = Request.request service method  where
    service = Request.ServiceName "ECS"
    method = Request.MethodName "runTask"
...
startTask = Request.request service method  where
    service = Request.ServiceName "ECS"
    method = Request.MethodName "startTask"
...
stopTask = Request.request service method  where
    service = Request.ServiceName "ECS"
    method = Request.MethodName "stopTask"
...
submitContainerStateChange = Request.request service method  where
    service = Request.ServiceName "ECS"
    method = Request.MethodName "submitContainerStateChange"
...
submitTaskStateChange = Request.request service method  where
    service = Request.ServiceName "ECS"
    method = Request.MethodName "submitTaskStateChange"
...
updateContainerAgent = Request.request service method  where
    service = Request.ServiceName "ECS"
    method = Request.MethodName "updateContainerAgent"
...
updateContainerInstancesState = Request.request service method  where
    service = Request.ServiceName "ECS"
    method = Request.MethodName "updateContainerInstancesState"
...
updateService = Request.request service method  where
    service = Request.ServiceName "ECS"
    method = Request.MethodName "updateService"
...
newtype Container = Container 
  ...
  , "healthStatus" :: NullOrUndefined.NullOrUndefined (HealthStatus)
  }
...
newtype HealthCheck = HealthCheck 
  { "command" :: (StringList)
  , "interval" :: NullOrUndefined.NullOrUndefined (BoxedInteger)
  , "timeout" :: NullOrUndefined.NullOrUndefined (BoxedInteger)
  , "retries" :: NullOrUndefined.NullOrUndefined (BoxedInteger)
  , "startPeriod" :: NullOrUndefined.NullOrUndefined (BoxedInteger)
  }
...
--   This may be useful if you need to immediately overwrite some of the optional values
newHealthCheck' :: StringList -> ( { "command" :: (StringList) , "interval" :: NullOrUndefined.NullOrUndefined (BoxedInteger) , "timeout" :: NullOrUndefined.NullOrUndefined (BoxedInteger) , "retries" :: NullOrUndefined.NullOrUndefined (BoxedInteger) , "startPeriod" :: NullOrUndefined.NullOrUndefined (BoxedInteger) } -> {"command" :: (StringList) , "interval" :: NullOrUndefined.NullOrUndefined (BoxedInteger) , "timeout" :: NullOrUndefined.NullOrUndefined (BoxedInteger) , "retries" :: NullOrUndefined.NullOrUndefined (BoxedInteger) , "startPeriod" :: NullOrUndefined.NullOrUndefined (BoxedInteger) } ) -> HealthCheck
